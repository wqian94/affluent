#!/usr/bin/env node
// Completely, utterly, and shamelessly borrowed from ganache-cli's cli.js file,
// with minor tweaks to use local settings as the default.
...
const options = JSON.parse(fs.readFileSync('settings')).server;
